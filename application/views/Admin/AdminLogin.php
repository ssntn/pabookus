...
<body class="adminloginpageBody">
	...
	<form method="post" autocomplete="off" action="<?=base_url('AdminRoutes/AdminLogin')?>" style="height:100%;">
	...
	<div class="row modregister-row_custom">
		...
		<div class="col-md-6 no-gutters modadminRightSide">
			<h1 class = "admin-login-h1">Admin Sign In</h1>
			<div class="mb-3 mb-3_custom">
				<div class="form-text-email-padding">
					<label for="CompanyID" class="form-label">Email:</label>
				</div>
